...
*  File Name: frf_metric_components.py
...
class CurveProcessor(object):
    ...
    detrend. Used identically across per-file feature scaling, centroid pairwise metrics
    (Correlation/RMSE/Wasserstein), the resonance-gate merge logic, baseline phase-lead/
    phase-lag classification, and multiple plotting modules — this is the single
    canonical implementation all of them share."""
